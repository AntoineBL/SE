...
public class TestProdCons extends Simulateur{
	...
	//Declaration des variables (XML)
 	...
 	private static MyObservateur myObservateur;
 	
 	
 	
	public TestProdCons(Observateur observateur, MyObservateur myObservateur) {
		super(observateur);
	...
	protected void run() throws Exception {
		...
		myObservateur.init(nbProd, nbCons, tailleBuffer);
		ProdCons buffer = new ProdCons(tailleBuffer, observateur, myObservateur);
